...
public class MainActivity extends AppCompatActivity
    ...
    private Integer[] imageUrls={R.drawable.c4,R.raw.img1,R.raw.img2,R.raw.img5};




    private Integer[] englishTexts={R.string.action_settings,R.string.crop_production_card_title_en,R.string.treatment_card_title_en,R.string.policy_card_title_en};

    private String[] backgroundColors={"#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent[] links={
                new Intent(MainActivity.this,croppred.class),
                new Intent(MainActivity.this, CropProductionActivity.class),
                new Intent(MainActivity.this, protmain.class),
                new Intent(MainActivity.this, govtschemes.class)
        };
